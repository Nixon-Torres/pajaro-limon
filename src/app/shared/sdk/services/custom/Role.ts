...
export class RoleApi extends BaseLoopBackApi {
  ...
  /**
   * Buscar un elemento relacionado por id para principals.
   *
   * @param {any} id role id
   *
   * @param {any} fk Clave foránea para principals
   *
  ...
  /**
   * Suprimir un elemento relacionado por id para principals.
   *
   * @param {any} id role id
   *
   * @param {any} fk Clave foránea para principals
  ...
  /**
   * Actualizar un elemento relacionado por id para principals.
   *
   * @param {any} id role id
   *
   * @param {any} fk Clave foránea para principals
  ...
  /**
   * Crea una nueva instancia en principals de este modelo.
   *
   * @param {any} id role id
   *
   * @param {object} data Request data.
  ...
  /**
   * Suprime todos los principals de este modelo.
   *
   * @param {any} id role id
   *
   * @returns {object} An empty reference that will be
