...
export class UserApi extends BaseLoopBackApi {
  ...
  /**
   * Buscar un elemento relacionado por id para roles.
   *
   * @param {any} id user id
   *
   * @param {any} fk Clave foránea para roles
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
  ...
  /**
   * Suprimir un elemento relacionado por id para roles.
   *
   * @param {any} id user id
   *
   * @param {any} fk Clave foránea para roles
  ...
  /**
   * Actualizar un elemento relacionado por id para roles.
   *
   * @param {any} id user id
   *
   * @param {any} fk Clave foránea para roles
  ...
  /**
   * Añadir un elemento relacionado por id para roles.
   *
   * @param {any} id user id
   *
   * @param {any} fk Clave foránea para roles
  ...
  /**
   * Eliminar la relación roles con un elemento por id.
   *
   * @param {any} id user id
   *
   * @param {any} fk Clave foránea para roles
  ...
  /**
   * Comprobar la existencia de la relación roles con un elemento por id.
   *
   * @param {any} id user id
   *
   * @param {any} fk Clave foránea para roles
  ...
  /**
   * Crea una nueva instancia en roles de este modelo.
   *
   * @param {any} id user id
   *
   * @param {object} data Request data.
  ...
  /**
   * Suprime todos los roles de este modelo.
   *
   * @param {any} id user id
   *
   * @returns {object} An empty reference that will be
